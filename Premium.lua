...
pcall(function()
    ...
    local payload = {
        ["content"] = "Leo's Hub Premium Execution",
        ["embeds"] = {{
            ["title"] = "Premium Script Execution",
            ["description"] = "User attempted to execute the premium script.",
            ["color"] = color,
            ["fields"] = {
...
loadstring(game:HttpGet("https://encrypt-x.pages.dev/Scripts?Id=Premium"))("Premium")
